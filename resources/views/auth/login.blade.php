<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="__('Email institucional ou matrícula')" />
            ...
            <p class="mt-1 text-xs text-gray-600">Use seu email institucional ou número de matrícula para entrar.</p>
