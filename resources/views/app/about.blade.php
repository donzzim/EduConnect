...
@section('content')
<x-nav>
    <a href="{{route('home')}}" class="text-2xl font-bold text-indigo-600 tracking-tight">Edu<span class="text-slate-800">Connect</span></a>
...
<header class="py-16 bg-gradient-to-b from-white to-slate-50">
    <div class="max-w-4xl mx-auto px-4 text-center">
        ...
        <p class="text-xl text-slate-600 leading-relaxed">
            O EduConnect não é apenas um diário de classe digital. É uma plataforma preditiva desenhada para o Ensino Médio, focada em garantir o sucesso de cada aluno antes mesmo do ano letivo terminar.
        </p>
    </div>
</header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <ul class="space-y-6">
                        <li class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-indigo-100 text-sm">Identificamos padrões de frequência e engajamento para prever possíveis desistências.</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 bg-white/20 p-2 rounded-lg text-white">
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg font-bold text-white uppercase tracking-wide">Risco de Reprovação</h4>
                                <p class="text-indigo-100 text-sm">Análise preditiva baseada no histórico de notas e evolução contínua do estudante.</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 bg-white/20 p-2 rounded-lg text-white">
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg font-bold text-white uppercase tracking-wide">Intervenção Pedagógica</h4>
                                <p class="text-indigo-100 text-sm">Sugerimos ações diretas para coordenadores e professores agirem no momento certo.</p>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="order-1 md:order-2">
                ...
                <p class="text-slate-600 mb-6 leading-relaxed">
                    Utilizamos modelos de <strong>Machine Learning</strong> treinados para analisar o comportamento acadêmico. O sistema processa dados inseridos diariamente por professores para gerar insights em tempo real.
                </p>
                <div class="space-y-4">
                    <div class="flex items-center p-4 bg-white rounded-xl border border-slate-200 shadow-sm">
                        ...
                        <span class="text-slate-700 font-medium">Dashboard intuitivo para diretores e coordenadores.</span>
                    </div>
                    <div class="flex items-center p-4 bg-white rounded-xl border border-slate-200 shadow-sm">
                        <i class="fa-solid fa-check-circle text-emerald-500 text-xl mr-3"></i>
